...
extern I2C_HandleTypeDef MPU6050_I2C;  // change your handler here accordingly
...
void MPU6050_Read_Accel (XYZ* output)
{
	uint8_t Rec_Data[6];
	...
	output->x = Accel_X_RAW/16384.0;
	output->y = Accel_Y_RAW/16384.0;
	output->z = Accel_Z_RAW/16384.0;
}

void MPU6050_Read_Gyro(XYZ* output)
{
    uint8_t Rec_Data[6];
    ...
    output->x = Gyro_X_RAW / 131.0;
    output->y = Gyro_Y_RAW / 131.0;
    output->z = Gyro_Z_RAW / 131.0;
}
